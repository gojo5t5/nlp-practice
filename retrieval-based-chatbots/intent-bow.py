...
response_a = preprocess(
    "All of our dresses sare cut from a polyester blend for a strechy fit"
)
response_b = preprocess(
    "The 'Elosie' dress runs large. I suggest you take your regular size or smaller for the best fit."
)
...
print(
    "Number of shared words between user_message and response_a: "
    + str(compare_overlap(bow_user_message, bow_response_a))
)

print(
    "Number of shared words between user_message and response_b: "
